...
See: `../edgecore-5610-re/ASIC_INIT_AND_DMA_MAP.md`, `../edgecore-5610-re/BDE_CMIC_REGISTERS.md`, `../edgecore-5610-re/WRITE_MECHANISM_ANALYSIS.md`
...
Key data: `../edgecore-5610-re/L3_NEXTHOP_FORMAT.md`, `../edgecore-5610-re/L3_ECMP_VLAN_WRITE_PATH.md`
...
Key data: `../edgecore-5610-re/ONIE_BOOT_AND_PARTITION_LAYOUT.md`
...
All RE docs are in `../edgecore-5610-re/` relative to this project.
...
| Packet I/O | `PACKET_IO_VERIFIED.md`, `PACKET_BUFFER_ANALYSIS.md`, `DMA_DCB_LAYOUT_FROM_KNET.md` |
